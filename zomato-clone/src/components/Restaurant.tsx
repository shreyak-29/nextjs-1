  ...
  const restaurantData = [
    {
      ...
      image: 'https://imgs.search.brave.com/XdkiI9cZxShFbCI7_hp6-2bhE07bqMSMwRWTahrxwZQ/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9jZG4u/cGl4YWJheS5jb20v/cGhvdG8vMjAxNy8w/Ni8wNi8yMi8zNy9p/dGFsaWFuLWN1aXNp/bmUtMjM3ODcyOV82/NDAuanBn',      rating: 4.5,
      cuisine: 'Italian',
      location: 'Bandra',
    },
    {
      ...
      image: 'https://imgs.search.brave.com/lnxoHgdGT6cL062WP7N0F39ftmV82QwaXbB8IRH_sS0/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9jZG4u/cGl4YWJheS5jb20v/cGhvdG8vMjAxOS8w/OC8wOS8xOC8zMi9z/dXNoaS1yb2xsLWlt/YWdlcy00Mzk1NTk4/XzY0MC5qcGc',      rating: 4.7,
      cuisine: 'Japanese',
      location: 'Andheri',
    },
    {
      ...
      image: 'https://imgs.search.brave.com/03ysq-K83FfcaqBgWKCAYCSmFdYGkifGJXFaBsnDut8/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90NC5m/dGNkbi5uZXQvanBn/LzA4LzYwLzg4Lzg1/LzM2MF9GXzg2MDg4/ODU2M19UbnJITGVV/V2VDZFpjVElESXpq/dE8yOVp4NkxPUFJS/bC5qcGc',      rating: 4.3,
      cuisine: 'Mexican',
      location: 'Parel',
    },
    {
      ...
      image: 'https://imgs.search.brave.com/-yLdJ0WJr848mwrkTsAdVT41WmcU47UVOHCCk_ZmC0o/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pbWcu/ZnJlZXBpay5jb20v/cHJlbWl1bS1waG90/by9zdHJlZXQtZm9v/ZC1mcmVzaC1idXJn/ZXJzLXdpdGgtYm94/LWJlZXItd29vZGVu/LXRhYmxlXzIyMDky/NS00ODA0LmpwZz9z/ZW10PWFpc19oeWJy/aWQ',      rating: 4.1,
      cuisine: 'American',
      location: 'Borivali',
    },
    {
            ...
            >
              <div className="relative h-48 sm:h-64 overflow-hidden bg-gray-200">
                <img
                  ...
                  onError={(e) => {
                    e.target.src = 'https://picsum.photos/800/600';  // Fallback image
                  }}
                />

...
const HeroSection = () => {
  ...
  const metroCities = [
    'Mumbai', 'Pune', 'Banglore', 'Delhi', 'Hyderabad', 'Chennai',
    'Nagpur', 'Kolkata', 'Ahmedabad', 'Jaipur', 'Lucknow', 'Kanpur'
  ];
      ...
      <div className="relative container mx-auto px-4 text-center">
        <div className={`transform transition-all duration-1000 ease-out ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Discover the best food from your favorite restaurants, all in one place. Order now for a taste of happiness!
          </p>
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <div className="relative flex w-full">
              ...
              {/* Search Button */}
              <button className="absolute right-2 top-1/2 -translate-y-1/2 bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-600 transform hover:scale-105 active:scale-95 transition-all duration-300">
                Search
              </button>
            </div>
          </div>
